...
class PlayStoreScraper:
    """
    Scraper class for google play store reviews of apps
    """

    def __init__(self):
        """
        Load configuration variables from the config file to work locally
        """
    ...
    def get_app_info(self, app_id):
        """
        Get basic information about the app's rating, total reviews and the like.
        """
        try:
            # Fetch the data from google play store
    ...
    def scrape_all_banks(self):
        ...
        """
         ...
         if app_info_list:
             ...
             app_info_df.to_csv(f"{DATA_PATHS['raw']}/app_info.csv")
